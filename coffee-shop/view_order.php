...
<head>
    ...
    <title>Coffee - Order detail page</title>
    ...
    <div class="main">
        ...
        <section class="order-detail">
                <div class="title">
                    ...
                    <h1> order detail</h1>
                    <p>jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj</p>
                    ...
                    <div class="box">
                        ...
                        <div class="col">
                            ...
                            <?php if($fetch_order['status']=='canceled') { ?>
                                <a href="chechout.php?get_id=<?= $fetch_product['id']; ?>" class="btn">oder again</a>
                           <?php }else{ ?>
                            <form method="post">
                                <button type="submit" name="cancel" onclick="return confirm('do you want to cancel this order?')">cancel order</button>
                            </form>
                            <?php } ?>
